...
![установка системы ВМ](image/07.png){ #fig:007 width=70% }

![Установка языка](image/08.png){ #fig:008 width=70% }

Указываю параметры установки

![Установка часового пояса](image/09.png){ #fig:009 width=70% }
...
![Р: Этап установки](image/11.png){ #fig:014 width=70% }


![Запущенная CentOS](image/16.png){ #fig:016 width=70% }
