...
![подготовка к работе](image/1.png)
...
![программа simpleid](image/2.png)
...
![результат программы simpleid](image/3.png)

6.	Усложнили программу, добавив вывод действительных идентификаторов.

![программа simpleid2](image/4.png)
...
![результат программы simpleid2](image/5.png)

13.	Написали программу readfile.c

![программа readfile](image/6.png)
...
![результат программы readfile](image/7.png)
...
![исследование Sticky-бита](image/8.png)
